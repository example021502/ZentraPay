...
import com.zentrapay_application.zentrapay_spring_boot_layer.modules.wallets.dtos.SupportedCurrencyDTO;
...
public interface CurrencyRepository extends JpaRepository<CurrencyModel, String> {
    ...
    List<SupportedCurrencyDTO> getCurrenciesByCurrencyCodes(@Param("countryCodes") List<String>currencyCodes);
}
