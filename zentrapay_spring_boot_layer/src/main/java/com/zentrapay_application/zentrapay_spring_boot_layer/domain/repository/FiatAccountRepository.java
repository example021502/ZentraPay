...
import com.zentrapay_application.zentrapay_spring_boot_layer.modules.wallets.dtos.FiatAccountDTO;
...
public interface FiatAccountRepository extends JpaRepository<FiatAccountModel, UUID> {
    List<FiatAccountDTO> findByWalletId(@Param("walletId") UUID walletId);
