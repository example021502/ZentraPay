...
public class OnafriqGatewayService implements PaymentGatewayService {
    ...
    public PaymentsResponseDTO processDisbursement(DisbursementRequestDTO request) {
        ...
        try {
            // ====================================================================
            // STEP 1: Create recipient on Onafriq network
            // Actual API call:
            // restClient.post()
            //     .uri("https://api.onafriq.com/v1/recipients")
            ...
            String recipientId = (String) ((Map<String, Object>) recipientResponse.get("data")).get("recipientId");
            log.info("[ONAFRIQ_GATEWAY] Recipient created: code={}", recipientId);

            // ====================================================================
            // STEP 2: Initiate cross-border money transfer
            // Actual API call:
            // restClient.post()
            //     .uri("https://api.onafriq.com/v1/transfers")
            //     .header("Authorization", "Bearer " + apiKey)
            //     .header("X-Partner-Id", partnerId)
            //     .body(payload)
            //     .retrieve()
