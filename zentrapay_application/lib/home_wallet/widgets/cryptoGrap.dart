...
//         list = data.where((element) => element.pair.contains(search)).toList();
//       else
//         list = data;
//     },
//     orElse: () => {},
...
//       .getExchanges(cancelToken: cancelToken);
//   return exchanges;
// });
...
//     data: (details) => details.favoritePair,
//     orElse: () => "",
//   );
...
// final pairOrderBookProvider = FutureProvider.family<OrderBook, Pair>((
//   ref,
//   pair,
// ) async {
//   final cancelToken = CancelToken();
...
// final tradesProvider = FutureProvider.family<List<Trade>, Pair>((
//   ref,
//   pair,
// ) async {
//   final cancelToken = CancelToken();
